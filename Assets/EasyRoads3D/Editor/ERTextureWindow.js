...
var dir : DirectoryInfo= new DirectoryInfo(Directory.GetCurrentDirectory() + OCQQOCDCCD.extensionPath + "Textures/Road Textures/");

assetPath = OCQQOCDCCD.extensionPath.Substring(1, OCQQOCDCCD.extensionPath.Length - 1);
...
var road : GameObject = roadscript.OQQCDCOCQO.road;
if(road != null){
