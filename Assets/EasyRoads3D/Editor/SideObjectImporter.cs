...
for(i = 0; i < ODOCDDOOCC.roadObjects.Length; i++){
comboValues.Add(ODOCDDOOCC.roadObjects[i]);
}
...
ODOCDDOOCC.OODDOQQOQC.Add(thisso);
}
}
}

ODOCDDOOCC.roadObjects = comboValues.ToArray();
ODOCDDOOCC.ODOCCQDQCC();
